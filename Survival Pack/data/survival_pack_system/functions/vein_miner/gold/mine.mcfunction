...
execute as @a[scores={VnMnrGold=1..}] at @s at @e[type=item,tag=VeinMiner,tag=GoldReady,distance=..15] if block ~1 ~ ~ gold_ore run setblock ~1 ~ ~ air destroy
execute as @a[scores={VnMnrGold=1..}] at @s at @e[type=item,tag=VeinMiner,tag=GoldReady,distance=..15] if block ~-1 ~ ~ gold_ore run setblock ~-1 ~ ~ air destroy
execute as @a[scores={VnMnrGold=1..}] at @s at @e[type=item,tag=VeinMiner,tag=GoldReady,distance=..15] if block ~ ~1 ~ gold_ore run setblock ~ ~1 ~ air destroy
execute as @a[scores={VnMnrGold=1..}] at @s at @e[type=item,tag=VeinMiner,tag=GoldReady,distance=..15] if block ~ ~-1 ~ gold_ore run setblock ~ ~-1 ~ air destroy
execute as @a[scores={VnMnrGold=1..}] at @s at @e[type=item,tag=VeinMiner,tag=GoldReady,distance=..15] if block ~ ~ ~1 gold_ore run setblock ~ ~ ~1 air destroy
...
scoreboard players set @a[scores={VnMnrGold=1..}] VnMnrGold 0