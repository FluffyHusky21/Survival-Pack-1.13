...
execute as @a[scores={VnMnrCoal=1..}] at @s at @e[type=item,tag=VeinMiner,tag=CoalReady,distance=..15] if block ~1 ~ ~ coal_ore run setblock ~1 ~ ~ air destroy
execute as @a[scores={VnMnrCoal=1..}] at @s at @e[type=item,tag=VeinMiner,tag=CoalReady,distance=..15] if block ~-1 ~ ~ coal_ore run setblock ~-1 ~ ~ air destroy
execute as @a[scores={VnMnrCoal=1..}] at @s at @e[type=item,tag=VeinMiner,tag=CoalReady,distance=..15] if block ~ ~1 ~ coal_ore run setblock ~ ~1 ~ air destroy
execute as @a[scores={VnMnrCoal=1..}] at @s at @e[type=item,tag=VeinMiner,tag=CoalReady,distance=..15] if block ~ ~-1 ~ coal_ore run setblock ~ ~-1 ~ air destroy
execute as @a[scores={VnMnrCoal=1..}] at @s at @e[type=item,tag=VeinMiner,tag=CoalReady,distance=..15] if block ~ ~ ~1 coal_ore run setblock ~ ~ ~1 air destroy
...
scoreboard players set @a[scores={VnMnrCoal=1..}] VnMnrCoal 0