...
execute as @a[scores={VnMnrDiamond=1..}] at @s at @e[type=item,tag=VeinMiner,tag=DiamondReady,distance=..15] if block ~1 ~ ~ diamond_ore run setblock ~1 ~ ~ air destroy
execute as @a[scores={VnMnrDiamond=1..}] at @s at @e[type=item,tag=VeinMiner,tag=DiamondReady,distance=..15] if block ~-1 ~ ~ diamond_ore run setblock ~-1 ~ ~ air destroy
execute as @a[scores={VnMnrDiamond=1..}] at @s at @e[type=item,tag=VeinMiner,tag=DiamondReady,distance=..15] if block ~ ~1 ~ diamond_ore run setblock ~ ~1 ~ air destroy
execute as @a[scores={VnMnrDiamond=1..}] at @s at @e[type=item,tag=VeinMiner,tag=DiamondReady,distance=..15] if block ~ ~-1 ~ diamond_ore run setblock ~ ~-1 ~ air destroy
execute as @a[scores={VnMnrDiamond=1..}] at @s at @e[type=item,tag=VeinMiner,tag=DiamondReady,distance=..15] if block ~ ~ ~1 diamond_ore run setblock ~ ~ ~1 air destroy
...
scoreboard players set @a[scores={VnMnrDiamond=1..}] VnMnrDiamond 0