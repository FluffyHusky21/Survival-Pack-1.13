...
execute as @e[type=item,tag=woodFall,tag=broken] at @s if entity @a[scores={treeMNR=1..},distance=..6] if block ~-1 ~ ~-1 #minecraft:logs run setblock ~-1 ~ ~-1 air destroy
execute as @e[type=item,tag=woodFall,tag=broken] at @s if entity @a[scores={treeMNR=1..},distance=..6] if block ~ ~ ~-1 #minecraft:logs run setblock ~ ~ ~-1 air destroy
execute as @e[type=item,tag=woodFall,tag=broken] at @s if entity @a[scores={treeMNR=1..},distance=..6] if block ~1 ~ ~-1 #minecraft:logs run setblock ~1 ~ ~-1 air destroy
execute as @e[type=item,tag=woodFall,tag=broken] at @s if entity @a[scores={treeMNR=1..},distance=..6] if block ~-1 ~ ~ #minecraft:logs run setblock ~-1 ~ ~ air destroy
execute as @e[type=item,tag=woodFall,tag=broken] at @s if entity @a[scores={treeMNR=1..},distance=..6] if block ~1 ~ ~ #minecraft:logs run setblock ~1 ~ ~ air destroy
execute as @e[type=item,tag=woodFall,tag=broken] at @s if entity @a[scores={treeMNR=1..},distance=..6] if block ~-1 ~ ~1 #minecraft:logs run setblock ~-1 ~ ~1 air destroy
...
execute as @e[type=item,tag=woodFall,tag=broken] at @s if entity @a[scores={treeMNR=1..},distance=..6] if block ~-1 ~1 ~-1 #minecraft:logs run setblock ~-1 ~1 ~-1 air destroy
execute as @e[type=item,tag=woodFall,tag=broken] at @s if entity @a[scores={treeMNR=1..},distance=..6] if block ~ ~1 ~-1 #minecraft:logs run setblock ~ ~1 ~-1 air destroy
execute as @e[type=item,tag=woodFall,tag=broken] at @s if entity @a[scores={treeMNR=1..},distance=..6] if block ~1 ~1 ~-1 #minecraft:logs run setblock ~1 ~1 ~-1 air destroy
execute as @e[type=item,tag=woodFall,tag=broken] at @s if entity @a[scores={treeMNR=1..},distance=..6] if block ~-1 ~1 ~ #minecraft:logs run setblock ~-1 ~1 ~ air destroy
execute as @e[type=item,tag=woodFall,tag=broken] at @s if entity @a[scores={treeMNR=1..},distance=..6] if block ~ ~1 ~ #minecraft:logs run setblock ~ ~1 ~ air destroy
...
scoreboard players set @a[scores={treeMNR=1..}] treeMNR 0