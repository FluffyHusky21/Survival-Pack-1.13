...
execute as @a[scores={sp_mnr_Redstone=1..}] at @s at @e[type=item,tag=VeinMiner,tag=RedstoneReady,distance=..15] if block ~1 ~ ~ redstone_ore run setblock ~1 ~ ~ air destroy
execute as @a[scores={sp_mnr_Redstone=1..}] at @s at @e[type=item,tag=VeinMiner,tag=RedstoneReady,distance=..15] if block ~-1 ~ ~ redstone_ore run setblock ~-1 ~ ~ air destroy
execute as @a[scores={sp_mnr_Redstone=1..}] at @s at @e[type=item,tag=VeinMiner,tag=RedstoneReady,distance=..15] if block ~ ~1 ~ redstone_ore run setblock ~ ~1 ~ air destroy
execute as @a[scores={sp_mnr_Redstone=1..}] at @s at @e[type=item,tag=VeinMiner,tag=RedstoneReady,distance=..15] if block ~ ~-1 ~ redstone_ore run setblock ~ ~-1 ~ air destroy
execute as @a[scores={sp_mnr_Redstone=1..}] at @s at @e[type=item,tag=VeinMiner,tag=RedstoneReady,distance=..15] if block ~ ~ ~1 redstone_ore run setblock ~ ~ ~1 air destroy
...
scoreboard players set @a[scores={sp_mnr_Redstone=1..}] sp_mnr_Redstone 0